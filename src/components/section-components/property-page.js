          ...
          <div className="row">
            <div className="col-lg-8">
              <div className="product-search-inner bg-main">
                <div className="row custom-gutters-20">
                  ...
                  <div className="mt-2 col-md-6 mt-md-0">
                  ...
                  <div className="mt-2 col-md-3 mt-md-0 align-self-center">
                  ...
                  <div className="single-product-wrap style-2">
                    ...
                    <div className="product-details-inner">
                      ...
                      <ul className="meta-inner">
                        ...
                        <li>
                          <Link to="/property-details">For Rent</Link>
                        </li>
                      </ul>
                      <p>Lorem ipsum dolor consetur </p>
                      <span className="price">80,650.00RWF/month</span>
                    </div>
              ...
              <div className="mt-4 text-center pagination-area">
            ...
            <div className="col-lg-4">
              <aside className="sidebar-area">
                <div className="text-center widget widget-author">
